...
public class GrafoNaoDirecionado extends Grafo{
	...
	public boolean insertAresta(int vertice1, int vertice2) {
        ...
        if (vertice1 < 0 || vertice2 < 0 || vertice1 == vertice2 
       	...
       	this.getListaAdjacencia().get(vertice2).add(vertice1);
        this.incrNumArestas();
        return true;
	}
	...
	public boolean deletedAresta(int vertice1, int vertice2) {
        ...
        if (this.getListaAdjacencia().get(vertice1) != null) {
        	...
        	index = this.getListaAdjacencia().get(vertice2).indexOf(vertice1);
        	this.getListaAdjacencia().get(vertice2).remove(index);
            this.decrNumArestas();
        }
        return true;
	}
